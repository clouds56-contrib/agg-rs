...
fn t26_aa_test() {
    ...
    for i in 1..=20 {
        ...
        let gradient_colors = color_gradient(
            agg::Rgb8::from_raw(255, 0, 0),
            agg::Rgb8::from_raw(0, 0, 255),
            256,
        );
        let x1 = 17.5 + (k * 4.0);
        let y1 = 107.;
        ...
        let colors = color_gradient(
            agg::Rgb8::from_raw(255, 0, 0),
            agg::Rgb8::from_raw(255, 255, 255),
            256,
        );
        let x1 = 21.5;
