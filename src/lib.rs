...
pub mod prelude {
    pub use crate::{
        Color as _, FromColor as _, FromRaw2 as _, FromRaw3 as _, FromRaw4 as _, NamedColor as _,
        Pixel as _, Render as _, Source as _,
    };

    pub use crate::{DrawOutline, Pixfmt, PixfmtAlphaBlend, RenderingBase};
    pub use crate::{
        Gray16, Gray32, Gray64, Gray8, Rgb16, Rgb32, Rgb64, Rgb8, Rgba16, Rgba32, Rgba64, Rgba8,
    };
